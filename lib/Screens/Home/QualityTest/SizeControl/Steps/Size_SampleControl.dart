...
import 'Size_StartSampleCheck.dart';

class Size_SampleControl extends StatefulWidget {
  @override
  _Size_SampleControlState createState() => _Size_SampleControlState();
}

class _Size_SampleControlState extends State<Size_SampleControl> {
  int IntiteStatus = 0;
        ...
        itemBuilder: (context, int i) {
          return SizeColorSampleList(PersonalCase, snapshot.data[i], () async {
            ...
            var value = await Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => Size_StartSampleCheck()));
            setState(() {
              print(value);
            });
          });
