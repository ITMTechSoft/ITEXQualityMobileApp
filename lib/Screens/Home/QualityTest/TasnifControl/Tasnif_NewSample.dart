...
class _Tasnif_NewSampleState extends State<Tasnif_NewSample> {
  ...
  Widget PageHeaderTitle(PersonalCase)=>  ListTile(
    title: HeaderTitle(
  ...
  Widget CreateSample(PersonalCase)=>Center(
      child: CustomButton(
  ...
  Widget ControlAmount(PersonalCase)=>Row(
  ...
  Widget ControlType(PersonalCase)=>Row(
    mainAxisAlignment: MainAxisAlignment.center,
    mainAxisSize: MainAxisSize.max,
    children: [
      Expanded(
  ...
  Widget FabricPartNo(PersonalCase)=>Row(
    mainAxisAlignment: MainAxisAlignment.center,
    mainAxisSize: MainAxisSize.max,
    children: [
      Expanded(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(children: [
        PageHeaderTitle(PersonalCase),
        SizedBox(height: ArgonSize.Padding3),
        CreateSample(PersonalCase),
        FutureBuilder(
